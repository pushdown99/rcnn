...
from data.coco_dataset import COCO_BBOX_LABEL_NAMES
from data.nia_dataset  import NIA_BBOX_LABEL_NAMES
...
def vis_bbox(img, bbox, label=None, score=None, ax=None):
    ...
    if opt.data == 'voc':
      ...
      label_names = list(NIA_BBOX_LABEL_NAMES) + ['bg']
    elif opt.data == 'vg':
      label_names = list(VG_BBOX_LABEL_NAMES) + ['bg']
    else:
      print ('[-] unkown vis_bbox dataset:', opt.data)
